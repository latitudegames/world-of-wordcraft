...
import TILES from "./atlantis-tile-mapping.js";
...
export default class DungeonScene extends Phaser.Scene {
  ...
  create() {
    ...
    this.groundLayer.setCollisionByExclusion([-1, 162, 163, 164, 165]);
    this.stuffLayer.setCollisionByExclusion([-1, 162, 163, 164, 165]);
