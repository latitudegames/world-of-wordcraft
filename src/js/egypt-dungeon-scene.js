...
import TILES from "./egypt-tile-mapping.js";
...
export default class DungeonScene extends Phaser.Scene {
  ...
  create() {
    ...
    this.groundLayer.setCollisionByExclusion([-1, 898, 899, 900, 901]);
    this.stuffLayer.setCollisionByExclusion([-1, 898, 899, 900, 901]);
